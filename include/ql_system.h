...
#define     MSG_ID_APP_PUSH         (MSG_ID_USER_START + 3)

#define     SEND_ALARM_MESSAGE          1
#define     SEND_CON_VUALE_MESSAGE      2
#define     SEND_SET_CHANGENED_MESSAGE  3
#define     SAVE_15MIN_DATA             4
#define     SEND_6HOUR_BIG_DATA         5
#define     SEND_24HOUR_POWER_DATA      6
#define     SEND_ANSER_CTL_DATA         7
